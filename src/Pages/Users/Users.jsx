    ...
    <>
      ...
      >
        <Select
          ...
          variant="outlined"
          style={{ width: "150px", height: "40px", marginLeft: "1040px" }}
        >
          <MenuItem value="all">All Users</MenuItem>
          <MenuItem value="Companies">Companies</MenuItem>
          <MenuItem value="JobSeekers">Seekers</MenuItem>
